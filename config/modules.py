...
def get_cache_module_lines(pref_data, repl_data):
    ...
    pref_nonbranch_variant_data = [
        ...
        ('prefetcher_cache_operate', (('uint64_t', 'addr'), ('uint64_t', 'objectID'), ('uint64_t', 'size'), ('uint8_t', 'cache_hit'), ('bool', 'useful_prefetch'), ('uint8_t', 'type'), ('uint32_t', 'metadata_in')), 'uint32_t', 'std::bit_xor'),
